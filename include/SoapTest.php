...
$soapclient = new nusoapclient('http://192.168.1.7:83/soap.php');  //define the SOAP Client an
$soapclient->setCredentials('GOLDJOY\michael.hui', 'mic74mic','ntlm'); //set windows credentials here
